...
% Specify the polygonal obstacles (in test.mat, the obstacles are randomly generated by generate_dense_obstacles.m)
global Nobs obstacle_vertexes_
Nobs = size(obstacle_vertexes_,2);

global hybrid_astar_
hybrid_astar_.resolution_x = 0.2;%init:0.2
...
global costmap_ costmap_ex costmap_aex
[costmap_,costmap_ex,costmap_aex] = CreateDilatedCostmap();

global optimization_
optimization_.Nfe = 200;
optimization_.dt_for_resampling = 0.01;
optimization_.unit_step = 0.03;
optimization_.nearest_step = 0.01;
